                ...
                <main className="flex-1">
                    ...
                    <div className="overflow-hidden bg-white shadow sm:rounded-lg">
                        <div className="px-4 py-5 sm:px-6">
                            <h3 className="text-lg font-medium leading-6 text-gray-900">Kurserstellung</h3>
                            <p className="mt-1 max-w-2xl text-sm text-gray-500">Erstellen Sie Ihren Kurs jetzt!</p>
                        </div>
                        <div className="border-t border-gray-200 px-4 py-5 sm:p-0">
                            <dl className="sm:divide-y sm:divide-gray-200">
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5 sm:px-6">
                                    <dt className="text-sm font-medium text-gray-500">Maximale Teilnehmeranzahl</dt>
                                    <div>
                                        <label htmlFor="email" className="sr-only">
                                            Max Teilnehmerzahl
                                        </label>
                                ...
                                <button class="w-full h-12 px-6 text-indigo-100 transition-colors duration-150 bg-green-700 rounded-lg focus:shadow-outline hover:bg-green-800 shadow-sm">Jetzt erstellen!</button>
                            </dl>
                        </div>
                    </div>
                </main>
